          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                  className="text-lg font-medium leading-6 text-gray-500 mb-5"
                >
                  Create Persona
                </Dialog.Title>
                    ...
                    <div className="space-y-2">
                      {models.map((model) => (
                        <RadioGroup.Option
                          ...
                          className={({ checked }) =>
                            `${
                              checked ? "bg-gray-500 text-white" : "bg-white"
                            } relative flex cursor-pointer rounded px-5 py-3 border focus:outline-none`
                          }
                        >
                            ...
                            <div className="flex items-center gap-5">
                              ...
                              <div className="text-sm">
                                ...
                                >
                                  ...
                                  <br />
                                  <span>
                                    Output: ${model.price.output} / 1K tokens
                                  </span>
                                </RadioGroup.Description>
                              </div>
                            </div>
                ...
                <div className="mt-4 flex justify-end">
                  <button
                    type="button"
                    onClick={router.back}
                    className="inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                  >
                    Cancel
                  </button>
                  <button
